...
//
//    /**
//     * Creates a thread to handle client conections
//     *
//     * @param socket The client socket
//     * @param tcpServerMain Reference to the main class
//     */
...
//
//            System.out.println("Send server public key to client");
...
//
//            System.out.println("Waiting to receive login or register");
//            byte[] authObject = (byte[]) in.readObject();
//            System.out.println(new String(authObject));
//            System.out.println("Received login or register");
//
//
//
//            //TODO
...
//
//            System.out.println("Credentials encoded");
//            byte[] credentialsEncoded = authObject;
...
//
//            System.out.println("Parssing byte : " + parts.length);
...
//
//                if (incoming instanceof String message2) {
